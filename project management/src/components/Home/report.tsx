    ...
    <div className="flex items-center justify-between max-w-6xl mx-auto px-6 py-16 gap-16">
      ...
      <div className="flex-1">
        ...
        <h2 className="text-4xl font-bold mt-6 mb-6">
          Detailed reports to track project progress.
        </h2>
        
        <p className="text-gray-600 mb-8">
          Decide if you want to throw it away retain it and continue with your 
          workflow unhindered. Need short bursts of productivity? Meet the 
