...
const Footer = () => {
  ...
  return (
    ...
    >
      <footer className="max-w-[1240px] mx-auto px-5 pt-20 pb-8 relative flex justify-center">
        ...
        >
          <div className="absolute inset-0 flex items-end justify-center pointer-events-none overflow-hidden">
            <div className="text-[250px] leading-none font-bold text-[#eeeeeed6] opacity-95">FlowSpace</div>
          </div>
          ...
          <div className="grid grid-cols-12 gap-8 mb-20 relative">
            ...
            >
              ...
              <p className="text-[#4B5563] text-base leading-[1.75] mb-8 pr-8">
                We provide seamless solutions to manage your projects and keep all your task arranged with our best
                product.
              </p>
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <a href="#" className="text-[#6366F1] text-sm hover:underline">
                    Open Map
                  </a>
                </div>
                <div>
      ...
      >
        <div className="flex justify-between items-center w-full max-w-[1240px] pt-2 border-t border-[#E5E7EB]">
          <p className="text-[#4B5563] text-sm">© 2024 FlowSpace. All Rights Reserved</p>
          <div className="flex gap-6">
            <a href="#" className="text-[#4B5563] hover:text-[#111827] text-sm">
              Terms & Conditions
            </a>
            <a href="#" className="text-[#4B5563] hover:text-[#111827] text-sm">
              Privacy Policy
